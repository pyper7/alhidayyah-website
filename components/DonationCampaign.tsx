...
export default function DonationCampaign({ campaign }: DonationCampaignProps) {
  // Default campaign data - replace with actual data from API or props
  const defaultCampaign: Campaign = {
    ...
    targetAmount: 5000000, // 5 million
    raisedAmount: 3200000, // 3.2 million
    quranVerse: {
  ...
  // Only render if campaign is active
